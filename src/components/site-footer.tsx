  ...
  return (
    <footer className="border-t border-border bg-surface-deep text-surface-deep-foreground">
      <div className="mx-auto grid max-w-7xl gap-10 px-5 py-14 sm:px-8 md:grid-cols-3 lg:px-10">
        ...
        <div><p className="text-xs font-bold uppercase tracking-[0.16em] text-primary">Fale conosco</p><a href={brand.phoneHref} className="mt-4 block text-sm transition-colors hover:text-primary">{brand.phone}</a><p className="mt-2 text-sm text-surface-deep-muted">{brand.email} (demonstrativo)</p><a className="mt-5 inline-flex items-center gap-2 text-sm text-primary" href="https://www.instagram.com/barbeariafinotrato/" target="_blank" rel="noreferrer"><Instagram className="size-4" /> @barbeariafinotrato</a></div>
      </div>
